...
nc_f = 'VCSN/drought/VCSN_Rainbc5k_1972-2000.nc' #r'/home/jing/python_project/olw_wwo/MaxTempCorr_VCSN_BCC-CSM1.1_2006-2010_RCP2.6.nc'
 # Your filename
...
# tmax = nc_fid.variables['tmax'][:]  # shape is time, lat, lon as shown above
# =============================================================================
...
#                     'statistic': u'Mean\nM'})
# w_nc_fid.variables['tmax'][:] = tmax[time_idx, lat_idx, lon_idx]
# w_nc_fid.close()  # close the new file
# 
# # A plot of the temperature profile for Darwin in 2012
# fig = plt.figure()
# plt.plot(dt_time, tmax[:, lat_idx, lon_idx], c='r')
# plt.plot(dt_time[time_idx], tmax[time_idx, lat_idx, lon_idx], c='b', marker='o')
# plt.text(dt_time[time_idx], tmax[time_idx, lat_idx, lon_idx], cur_time,\
#          ha='right')
# fig.autofmt_xdate()
...
# departure = tmax[:, :, :] - tmax[:, lat_idx, lon_idx].reshape((time.shape[0],\
#                                                              1, 1))
# 
# # Open a new NetCDF file to write the data to. For format, you can choose from
# # 'NETCDF3_CLASSIC', 'NETCDF3_64BIT', 'NETCDF4_CLASSIC', and 'NETCDF4'
